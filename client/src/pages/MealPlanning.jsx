...
function MealPlanning() {
  ...
  return (
    <>
      ...
      <div className="flex flex-row h-screen rounded-r-lg  bg-white">
    ...
    >
      ...
      <span className="text-xs md:text-base hidden md:inline">Home</span>
        ...
        {/* Content Area */}
        <div className="flex-1 p-4 md:p-8 bg-#dbebd ml-[80px] flex-1 overflow-x-hidden" style={{ fontFamily: 'Georgia, serif' }}>
